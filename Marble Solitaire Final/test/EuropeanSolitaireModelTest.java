...
/**
 * This tests the EuropeanSolitaire model.
 */
public class EuropeanSolitaireModelTest {
  ...
  public void initConditions() {
    ...
    this.board2 = new EuropeanSolitaireModel(4, 3);
    this.board3 = new EuropeanSolitaireModel(3);
    this.board4 = new EuropeanSolitaireModel(5);
    this.board6 = new EuropeanSolitaireModel(5, 5, 5);
  }

  @Test
  public void getScore() {
    assertEquals(36, this.board1.getScore());
    assertEquals(36, this.board2.getScore());
    assertEquals(128, this.board4.getScore());
    assertEquals(128, this.board6.getScore());
  }
  ...
  public void testCornerMove() {
    MarbleSolitaireModel board7 = new EuropeanSolitaireModel(3, 4, 1);
    board7.move(2, 1, 4, 1);
    assertEquals(MarbleSolitaireModelState.SlotState.Empty, board7.getSlotAt(3, 1));
    assertEquals(MarbleSolitaireModelState.SlotState.Empty, board7.getSlotAt(2, 1));
    assertEquals(MarbleSolitaireModelState.SlotState.Marble, board7.getSlotAt(4, 1));
  }

  @Test
  public void testCornerMove2() {
    MarbleSolitaireModel board8 = new EuropeanSolitaireModel(3, 1, 5);
    board8.move(3, 5, 1, 5);
    assertEquals(MarbleSolitaireModelState.SlotState.Empty, board8.getSlotAt(2, 5));
    assertEquals(MarbleSolitaireModelState.SlotState.Empty, board8.getSlotAt(3, 5));
    assertEquals(MarbleSolitaireModelState.SlotState.Marble, board8.getSlotAt(1, 5));
  }
